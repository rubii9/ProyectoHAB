...
-- Espacio 2
insert into equipment (id, space_id, name, number) values (6, 2, 'sillas', 8);
insert into equipment (id, space_id, name, number) values (7, 2, 'mesas', 8);
insert into equipment (id, space_id, name, number) values (8, 2, 'monitores', 8);
...
insert into equipment (id, space_id, name, number) values (11, 2, 'taquillas', 8);
...
insert into equipment (id, space_id, name, number) values(19, 4, 'mesas', 1);
